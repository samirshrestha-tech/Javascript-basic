...
// /*An n-diglt number is considered a "covering
// number' if it makes use of allthe digits 1 to n
/*exactly once, where n is the number of non-
zero digits. For example, 2143 and 103245 are
both *covering numbers", while 20010043 and
113245 are not.
Write a function that takes a single integer,
and returns a value according to the following
rules:
If the number is a "covering number'. retum
the number of zeroes as a positive integer. For
example, 2143 would produce a result of "0".
while 103245 would produce a result of *1".
If the number is not a "covering number",
retum "-1".  */

// function covering(number) {
...
//     if (char !== 0 && i !== numstr.indexOf(char)) {
//       return -1;
//     }
//   }
//   return counter;
// }
// console.log(covering(3452600));
